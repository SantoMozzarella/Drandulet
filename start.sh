...
case $CHOICE in
        1)
            ...
            ;;
        2)
            curl -s https://raw.githubusercontent.com/SantoMozzarella/Drandulet/master/elements/pf.sh --create-dirs -o ~/drandulet/pf.sh && chmod 400 ~/drandulet/pf.sh && chmod +x ~/drandulet/elements/pf.sh && bash ~/drandulet/elements/pf.sh
            ;;
