...
case $CHOICE in
        1)
            ...
            ;;
        2)
            curl -s https://raw.githubusercontent.com/SantoMozzarella/Drandulet/master/elements/pf.sh --create-dirs -o ~/drandulet/elements/pf.sh && cd ~/drandulet/elements/ && chmod +x ~/drandulet/elements/pf.sh && bash ~/drandulet/elements/pf.sh
            ;;
